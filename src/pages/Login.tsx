          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center cursor-pointer group">
              <div className="relative">
                ...
                />
                <div className="w-5 h-5 border-2 border-gray-300 rounded transition-all peer-checked:bg-gray-900 peer-checked:border-gray-900 flex items-center justify-center group-hover:border-gray-400">
                  {rememberMe && (
                    <svg
